...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // Base: Colemak Mod-DH + home row mods
    [0] = LAYOUT(
...
XXXXXXX, XXXXXXX,      XXXXXXX,      LT(3, KC_CAPS), LT(1, KC_SPC), LT(2, KC_ESC), XXXXXXX, XXXXXXX, LT(2, KC_ENT), LT(1, KC_BSPC), LT(3, KC_DEL), XXXXXXX,      XXXXXXX,      XXXXXXX
    ...
    // Symbols (Based on BEAKL 15)
    [1] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, _______, KC_LT,   KC_UNDS, KC_GT,   _______, XXXXXXX, XXXXXXX, _______, KC_LCBR, KC_PLUS, KC_RCBR, _______, XXXXXXX,
_______, KC_CIRC, KC_LPRN, KC_MINS, KC_RPRN, KC_HASH, XXXXXXX, XXXXXXX, KC_ASTR, KC_LBRC, KC_EQL,  KC_RBRC, KC_DLR,  _______,
XXXXXXX, KC_PERC, KC_AT,   KC_GRV,  KC_EXLM, _______, XXXXXXX, XXXXXXX, _______, KC_AMPR, KC_TILD, KC_PIPE, KC_BSLS, XXXXXXX,
XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
    ),
    // Number Row and Nav Keys (Based on Miryoku)
    [2] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, _______, KC_7,         KC_8,         KC_9,         KC_MINS, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, XXXXXXX,
...
XXXXXXX, XXXXXXX, XXXXXXX,      _______,      _______,      _______, XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
    ...
    // Nav and Mouse Keys (Based on Miryoku)
    [3] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, QK_BOOT, _______, MS_BTN4, MS_BTN5, _______, XXXXXXX, XXXXXXX, _______, _______, _______, _______, _______, XXXXXXX,
