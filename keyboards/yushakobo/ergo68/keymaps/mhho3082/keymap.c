...
XXXXXXX, XXXXXXX,      XXXXXXX,      LT(3, KC_CAPS), LT(1, KC_SPC), LT(2, KC_ESC), XXXXXXX, XXXXXXX, LT(2, KC_ENT), LT(1, KC_BSPC), LT(3, KC_DEL), XXXXXXX,      XXXXXXX,      XXXXXXX
    ...
    [1] = LAYOUT(
XXXXXXX, XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,                   XXXXXXX, XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,      XXXXXXX,
XXXXXXX, KC_LABK,      KC_LPRN,      KC_UNDS,      KC_RPRN,      KC_RABK, XXXXXXX, XXXXXXX, KC_LCBR, KC_LBRC,      KC_EQL,       KC_RBRC,      KC_RCBR,      XXXXXXX,
KC_CIRC, LALT_T(KC_1), LGUI_T(KC_2), LCTL_T(KC_3), LSFT_T(KC_4), KC_5,    XXXXXXX, XXXXXXX, KC_6,    RSFT_T(KC_7), RCTL_T(KC_8), RGUI_T(KC_9), RALT_T(KC_0), KC_DLR,
XXXXXXX, KC_PERC,      KC_AT,        KC_MINS,      KC_EXLM,      KC_HASH, XXXXXXX, XXXXXXX, KC_GRV,  KC_ASTR,      KC_PLUS,      KC_AMPR,      KC_BSLS,      XXXXXXX,
XXXXXXX, XXXXXXX,      XXXXXXX,      _______,      _______,      _______, XXXXXXX, XXXXXXX, _______, _______,      _______,      XXXXXXX,      XXXXXXX,      XXXXXXX
    ),
    // Navigation (Inspired by Miryoku)
    [2] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   XXXXXXX, XXXXXXX, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  XXXXXXX,
_______, KC_LALT, KC_LGUI, KC_LCTL, KC_LSFT, _______, XXXXXXX, XXXXXXX, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
...
XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
    ...
    [3] = LAYOUT(
XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
XXXXXXX, QK_BOOT, _______, MS_BTN4, MS_BTN5, _______, XXXXXXX, XXXXXXX, _______, KC_MPLY, KC_VOLD, KC_VOLU, KC_MUTE, XXXXXXX,
